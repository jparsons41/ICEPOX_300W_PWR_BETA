...
static uint8_t startupRegisterConfigurationValues[BLDC_CFG_LEN * 2] = {
	...
	0x24,0x01,    //r4
	0x2c,0x00,    //r5
	0x34,0xfe,    //r6		Dsp via EC  changed from fe to ff for correct parity  8/14/2019
	0x3d,0x3f,    //r7
	0x44,0x7f,    //r8
	0x4c,0x00,    //r9
	0x54,0x00,    //r10
...
static uint8_t steadyStateRegisterConfigurationValues[BLDC_CFG_LEN * 2] = {
	...
	0xbc,0x03,    //r23
	0xc4,0x00,    //r24
	0xce,0x81,    //r25		DSp via clancyE, was a1 now 81   8/14/2019
	0xd5,0x81,    //r26
	0xdd,0x77,    //r27		DSp via EC, was 76, now 77 for parity   8/14/2019
	0xe6,0x00,    //r28
	0xec,0x8e,    //r29
	0xf6,0x01    //r30
};
